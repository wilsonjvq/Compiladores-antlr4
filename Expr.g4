...
// Parser rules (Producciones o no terminales) (Gramaticas libres de contexto)
programa:
	bloque
;
...
// Lexer rules (Tokens o terminales) (Expresiones regulares)
T_FLOAT: ('0'..'9')+'.'('0'..'9')+;
T_INT: ('0'..'9')+;
T_PLUS: '+';
T_MINUS: '-';
...
//Ejecutar en (cmd - Comand Prompt): Control + Shift + ñ 
//java -jar antlr-4.13.0-complete.jar Expr.g4

//Siempre para empezar el uso, en la terminal de comandos (CMD), realice un set del PATH antlr:

//doskey antlr4=java org.antlr.v4.Tool $*
//doskey grun =java org.antlr.v4.gui.TestRig $*
//>>> SET CLASSPATH=.;C:\proyecto-compiladores;%CLASSPATH%
//>>> antlr4
